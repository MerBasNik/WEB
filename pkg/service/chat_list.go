...
func (s *ChatListService) FindThreeByHobby(list_users []int) ([]chat.UserHobby, []int, error) {
	return s.repo.FindThreeByHobby(list_users)
}

func (s *ChatListService) FindTwoByHobby(list_users []int) ([]chat.UserHobby, []int, error) {
